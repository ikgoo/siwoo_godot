...
const CONSTELLATION_MIN_X = 324
const CONSTELLATION_MAX_X = 524
const CONSTELLATION_MIN_Y = 152
const CONSTELLATION_MAX_Y = 208
...
var line_star_pairs = {
	...
	"third_plus_four": ["3", "4"],
	"four_plus_fifth": ["4", "5"],
	"fifth_plus_sixth": ["5", "6"],
	"sixth_plus_seven": ["6", "7"],
	"four_plus_seven": ["4", "7"]
}
