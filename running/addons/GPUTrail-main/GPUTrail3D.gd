...
@onready var _old_pos : Vector3 = Vector3(global_position.x,global_position.y,global_position.z - 10)
...
func _process(delta):
	...
	_old_pos = Vector3(global_position.x,global_position.y,global_position.z - 10)
